        ...
        <AnimatePresence>
            ...
            >
                ...
                <div className="flex flex-col items-center px-6 max-w-md w-full">
                    ...
                    {state === "countdown" && (
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className="text-[150px] font-bold text-white font-heading leading-none"
                            >
                                {delayRemaining}
                            </motion.div>
                        </motion.div>
                    ...
                    {/* Running/Paused State - Stopwatch counting UP */}
                            ...
                            <div className="relative mb-8">
                                <svg width="280" height="280" className="transform -rotate-90">
                                    ...
                                    <circle
                                        ...
                                        strokeWidth="8"
                                    />
                                    {/* Progress circle - fills as we approach target */}
                                    <motion.circle
                                        cx="140"
                                        cy="140"
                                        r="120"
                                        fill="none"
                                        stroke={elapsedSeconds >= targetSeconds ? "url(#successGradient)" : "url(#gradient)"}
                                        strokeWidth="12"
                                        strokeLinecap="round"
