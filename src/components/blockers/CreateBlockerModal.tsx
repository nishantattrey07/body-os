...
import { createBlocker } from "@/app/actions/blockers";
...
export function CreateBlockerModal({ onClose, onCreated }: CreateBlockerModalProps) {
  ...
  const handleSubmit = async () => {
    if (!name.trim() || !bodyPart) {
      alert("Please provide a name and body part");
      return;
    }
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full p-4 rounded-2xl border border-zinc-200 text-lg"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full p-4 rounded-2xl border border-zinc-200 text-lg bg-white"
            >
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full p-4 rounded-2xl border border-zinc-200 resize-none h-24"
            />
          </div>
        </div>
