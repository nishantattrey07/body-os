...
async function main() {
    ...
    const exercises = [
        // PUSH
        { name: 'Incline Pushups', defaultReps: 15, defaultSets: 3, category: 'Push', isSystem: true, userId: null as any },
        { name: 'Diamond Pushups', defaultReps: 10, defaultSets: 3, category: 'Push', isSystem: true, userId: null as any },
        { name: 'Plank', defaultReps: 60, defaultSets: 3, category: 'Core', isSystem: true, userId: null as any }, // Safe alternative
        { name: 'Pike Pushups', defaultReps: 12, defaultSets: 3, category: 'Push', isSystem: true, userId: null as any },
        { name: 'Dips', defaultReps: 10, defaultSets: 3, category: 'Push', isSystem: true, userId: null as any },
        // PULL
        { name: 'Pull-ups', defaultReps: 8, defaultSets: 4, category: 'Pull', isSystem: true, userId: null as any },
        { name: 'Negative Pull-ups', defaultReps: 5, defaultSets: 4, category: 'Pull', isSystem: true, userId: null as any },
        { name: 'Australian Rows', defaultReps: 12, defaultSets: 3, category: 'Pull', isSystem: true, userId: null as any },
        { name: 'Dead Hangs', defaultReps: 60, defaultSets: 3, category: 'Pull', isSystem: true, userId: null as any },
        // LEGS
        { name: 'Bodyweight Squats', defaultReps: 20, defaultSets: 3, category: 'Legs', isSystem: true, userId: null as any },
        { name: 'Bulgarian Split Squats', defaultReps: 12, defaultSets: 3, category: 'Legs', isSystem: true, userId: null as any },
        // CORE
        { name: 'Hollow Body Rocks', defaultReps: 20, defaultSets: 3, category: 'Core', isSystem: true, userId: null as any },
        { name: 'Hanging Knee Raises', defaultReps: 12, defaultSets: 3, category: 'Core', isSystem: true, userId: null as any },
    ]
    ...
    for (const exercise of exercises) {
        const created = await prisma.exercise.upsert({
            where: {
                name_userId: {
                    name: exercise.name,
                    userId: null as any, // System exercises have userId = null
                }
            },
